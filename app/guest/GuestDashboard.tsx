...
export default function GuestDashboard({ initialPosts }: { initialPosts: Post[] }) {
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
              <div className="bg-gray-900 border border-purple-700 rounded-xl p-8 shadow-xl sm:max-w-sm max-w-[250px] w-full">
                ...
                <div className="flex justify-end gap-4">
                  ...
                  <button className="sm:text:lg text-sm px-4 py-2 rounded bg-red-600 text-white hover:bg-red-700">
                    Delete
                  </button>
                </div>
              </div>
                        ...
                        <div className="mt-auto">
                          <div className="flex justify-between items-center gap-2">
                            ...
                            <div className="flex gap-2">
                              {editingPostId === post.id ? (
                                <>
                                  <button className="px-3 py-1 bg-gradient-to-r from-green-600 to-blue-600 rounded text-white text-xs font-semibold hover:from-green-700 hover:to-blue-700 transition">
                                    Save
                                  </button>
                                  <button
